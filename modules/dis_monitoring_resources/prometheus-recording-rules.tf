...
output "node_recording_rules_id" {
  ...
  value       = azurerm_monitor_alert_prometheus_rule_group.node_recording_rules_linux.id
}

output "kubernetes_recording_rules_id" {
  description = "ID of the Kubernetes Recording Rules rule group"
  value       = azurerm_monitor_alert_prometheus_rule_group.kubernetes_recording_rules_linux.id
}

output "ux_recording_rules_id" {
  description = "ID of the UX Recording Rules rule group"
  value       = azurerm_monitor_alert_prometheus_rule_group.ux_recording_rules_linux.id
}

...
| <a name="input_lb_source_range_apim"></a> [lb\_source\_range\_apim](#input\_lb\_source\_range\_apim) | Load balancer source IP range for APIM IPv4 | `string` | `"127.0.0.1/32"` | no |
| <a name="input_lb_source_range_apim_ipv6"></a> [lb\_source\_range\_apim\_ipv6](#input\_lb\_source\_range\_apim\_ipv6) | Load balancer source IP range for APIM IPv6 | `string` | `"::1/128"` | no |
